...
const ShowInfoDetail = (props) => {
     ...
     const arr = [props.info.move_from, ...props.info.sub_spots]
     const arr1 = [...props.info.sub_spots, props.info.move_to]
                    ...
                    <div className="flex flex-row">
                         <div className="w-[286px] h-auto border-2 border-grey-600 rounded-lg mr-[50px] mt-2">
                              <div className="p-2">
                                   ...
                                   <a href={`${props.info.move_from.place.map_url}`}>Побачити на карті</a>
                         ...
                         {props.info.sub_spots.map((road, index) => (
                              <div key={index} className="w-[286px] h-auto border-2 border-grey-600 rounded-lg mr-[50px] mt-2" >
                                   <div className="p-2">
                                        ...
                                        <a href={`${road.place.map_url}`}>Побачити на карті</a>
                                        <p>Час: {road.date}</p>
                                   </div>
                              </div>
                         ))}
