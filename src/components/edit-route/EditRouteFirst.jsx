...
import { onChangeValue } from "../../features/editRoute/editRouteData";
               ...
               <div className="border-2 border-gray-300 w-[600px] mx-auto flex flex-col rounded-lg p-4">
                    ...
                    <div className="mt-4 min-h-[70px] flex justify-center">
                         <TextField
                              ...
                              label="Країна відпр.*"
                              variant="outlined"
                              value={route_to_change.move_from.place.country}
                    ...
                    <div className="mt-4 min-h-[70px] flex justify-center">
                         <TextField
                              ...
                              variant="outlined"
                              value={route_to_change.move_from.place.city}
                    ...
                    <div className="mt-4 min-h-[70px] flex justify-center">
                         <TextField
                              ...
                              label="Вулиця відпр.*"
                              variant="outlined"
                              value={route_to_change.move_from.place.street}
                    ...
                    <div className="mt-4 min-h-[70px] flex justify-center">
                         <TextField
                              ...
                              label="Мапа"
                              variant="outlined"
                              value={route_to_change.move_from.place.map_url}
                    ...
                    <div className="mt-4 min-h-[70px] flex justify-center">
                         <TextField
                              ...
                              label="Країна приб.*"
                              variant="outlined"
                              value={route_to_change.move_to.place.country}
                    ...
                    <div className="mt-4 min-h-[70px] flex justify-center">
                         <TextField
                              ...
                              variant="outlined"
                              value={route_to_change.move_to.place.city}
                    ...
                    <div className="mt-4 min-h-[70px] flex justify-center">
                         <TextField
                              ...
                              label="Вулиця приб.*"
                              variant="outlined"
                              value={route_to_change.move_to.place.street}
                    ...
                    <div className="mt-4 min-h-[70px] flex justify-center">
                         <TextField
                              ...
                              label="Мапа"
                              variant="outlined"
                              value={route_to_change.move_to.place.map_url}
                         ...
                         >
                              <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={activeKey1 === 1}>
                                   <TextareaAutosize
                                        ...
                                        value={route_to_change.description.ua}
                              ...
                              <CTabPane role="tabpanel" aria-labelledby="profile-tab" visible={activeKey1 === 2}>
                                   <TextareaAutosize
                                        className={defultClassTextArea}
                                        value={route_to_change.description.en}
                              ...
                              <CTabPane role="tabpanel" aria-labelledby="contact-tab" visible={activeKey1 === 3}>
                                   <TextareaAutosize
                                        className={defultClassTextArea}
                                        value={route_to_change.description.pl}
                         ...
                         >
                              <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={activeKey2 === 1}>
                                   <TextareaAutosize
                                        label="ds"
                                        className={defultClassTextArea}
                                        value={route_to_change.rules.ua}
                              ...
                              <CTabPane role="tabpanel" aria-labelledby="profile-tab" visible={activeKey2 === 2}>
                                   <TextareaAutosize
                                        className={defultClassTextArea}
                                        value={route_to_change.rules.en}
                              ...
                              <CTabPane role="tabpanel" aria-labelledby="contact-tab" visible={activeKey2 === 3}>
                                   <TextareaAutosize
                                        className={defultClassTextArea}
                                        value={route_to_change.rules.pl}
                         ...
                         >
                              <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={activeKey3 === 1}>
                                   <TextareaAutosize
                                        label="ds"
                                        className={defultClassTextArea}
                                        value={route_to_change.transportation_rules.ua}
                              ...
                              <CTabPane role="tabpanel" aria-labelledby="profile-tab" visible={activeKey3 === 2}>
                                   <TextareaAutosize
                                        className={defultClassTextArea}
                                        value={route_to_change.transportation_rules.en}
                              ...
                              <CTabPane role="tabpanel" aria-labelledby="contact-tab" visible={activeKey3 === 3}>
                                   <TextareaAutosize
                                        className={defultClassTextArea}
                                        value={route_to_change.transportation_rules.pl}
